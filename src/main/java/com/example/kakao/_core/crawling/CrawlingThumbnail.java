...
//         Document doc = Jsoup
//                 .connect("http://127.0.0.1:5500/src/main/java/com/example/kakao/_core/crawling/dummy/4.html")
//                 .get();
...
//                 String sql = "INSERT INTO episode_tb (`webtoon_id`, `detail_title`,`star_count`,`is_read`,`thumbnail`,`created_at`) VALUES "
//                         + " (" + WTid + ",'" + episode.getDetailTitle() + "', " + episode.getStarCount() + ", false, '"
